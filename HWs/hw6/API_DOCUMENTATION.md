# CS571 S25 HW6 API Documentation

## At a Glance

All routes are relative to `https://cs571.org/rest/s25/hw6/`
...
`GET` `https://cs571.org/rest/s25/hw6/chatrooms`
...
`GET` `https://cs571.org/rest/s25/hw6/messages?chatroom=CHATROOM_NAME&page=PAGE_NUM`
...
### Registering a User
`POST` `https://cs571.org/rest/s25/hw6/register`
...
`POST` `https://cs571.org/rest/s25/hw6/login`
...
`POST` `https://cs571.org/rest/s25/hw6/messages?chatroom=CHATROOM_NAME`
...
### Deleting a Message
`DELETE` `https://cs571.org/rest/s25/hw6/messages?id=MESSAGE_ID`
...
### Logging out
`POST` `https://cs571.org/rest/s25/hw6/logout`
...
### Who Am I?
`GET` `https://cs571.org/rest/s25/hw6/whoami`
