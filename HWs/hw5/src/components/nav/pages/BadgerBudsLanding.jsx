    ...
    <div>
      ...
      <Container fluid={true}>
        <Row>
          <Col xs={12} lg={4} xl={6}>
            <p>
              Badger Buddies is a proxy website (built by you!) for cats on{" "}
              <a href="https://www.madisoncatproject.org/">
            ...
            <p>
              ...
              <strong>February 20th, 2025.</strong>
            </p>
            <p>
          ...
          <Col xs={12} lg={8} xl={6}>
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/RK65p_-n3z0?si=ta9VsCE5d72Sjtk6"
